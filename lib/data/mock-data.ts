...
export const mockRecipes: Recipe[] = [
  ...
  },
  {
    ...
    ingredients: [
      { id: "eggs-2", name: "Eggs", quantity: "4", category: "dairy" },
      { id: "tomatoes-2", name: "Chopped tomatoes (can)", quantity: "1", category: "pantry" },
      { id: "bell-pepper-3", name: "Bell pepper", quantity: "1", category: "produce" },
      { id: "onion-2", name: "Onion", quantity: "1", category: "produce" },
      { id: "garlic-2", name: "Garlic", quantity: "2 cloves", category: "produce" },
      { id: "cumin", name: "Ground cumin", quantity: "1 tsp", category: "pantry" },
      { id: "paprika", name: "Smoked paprika", quantity: "1 tsp", category: "pantry" },
      { id: "feta-3", name: "Feta", quantity: "50 g", category: "dairy" },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      { id: "lentils", name: "Red lentils", quantity: "250 g", category: "pantry" },
      { id: "onion-3", name: "Onion", quantity: "1", category: "produce" },
      { id: "carrot-3", name: "Carrots", quantity: "2", category: "produce" },
      { id: "garlic-3", name: "Garlic", quantity: "2 cloves", category: "produce" },
      { id: "curry-powder", name: "Curry powder", quantity: "2 tbsp", category: "pantry" },
      { id: "coconut-milk", name: "Coconut milk", quantity: "400 ml", category: "pantry" },
      { id: "vegetable-stock", name: "Vegetable stock", quantity: "1 L", category: "pantry" },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      { id: "tuna", name: "Canned tuna", quantity: "2 cans", category: "protein" },
      { id: "quinoa-2", name: "Quinoa", quantity: "150 g", category: "grains" },
      { id: "cherry-tomatoes", name: "Cherry tomatoes", quantity: "200 g", category: "produce" },
      { id: "cucumber-3", name: "Cucumber", quantity: "1", category: "produce" },
      { id: "red-onion", name: "Red onion", quantity: "½", category: "produce" },
      { id: "olives", name: "Kalamata olives", quantity: "60 g", category: "pantry" },
      { id: "feta-2", name: "Feta", quantity: "80 g", category: "dairy" },
      { id: "lemon-3", name: "Lemon", quantity: "1", category: "produce" },
      { id: "olive-oil", name: "Olive oil", quantity: "2 tbsp", category: "pantry" },
    ],
    steps: [
  ...
  },
  {
    ...
    ingredients: [
      { id: "chickpeas-2", name: "Chickpeas (can)", quantity: "1", category: "pantry" },
      { id: "olive-oil-2", name: "Olive oil", quantity: "1 tbsp", category: "pantry" },
      { id: "smoked-paprika-2", name: "Smoked paprika", quantity: "1 tsp", category: "pantry" },
      { id: "cumin-2", name: "Ground cumin", quantity: "½ tsp", category: "pantry" },
    ],
    steps: [
...
export const mockGroceryItems: GroceryItem[] = [
  ...
  { id: "g-olive-oil", name: "Olive oil", quantity: "1 bottle", category: "pantry" },
  { id: "g-almond-butter", name: "Almond butter", quantity: "1 jar", category: "pantry" },
  { id: "g-honey", name: "Honey", quantity: "1 jar", category: "pantry" },
  { id: "g-paprika", name: "Smoked paprika", quantity: "1 jar", category: "pantry" },
