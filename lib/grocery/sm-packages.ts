...
export const SM_PACKAGES: Record<string, RetailPackage[]> = {
  ...
  // Filipino home-cooking staples.
  "fish sauce": [shape("bottle", "200 ml bottle (~13 tbsp)", 13, "tbsp")],
  vinegar: [shape("bottle", "385 ml bottle (~26 tbsp)", 26, "tbsp")],
  "shrimp paste": [shape("pack", "250 g jar (~16 tbsp)", 16, "tbsp")],
  "bay leaf": [shape("pack", "pack (20 leaves)", 20, "piece")],
  peppercorn: [shape("pack", "small jar (~40 tsp)", 40, "tsp")],
  calamansi: [shape("piece", "piece", 1, "piece")],
  "rice noodle": [shape("pack", "227 g pack", 227, "g")],
  "spring roll wrapper": [shape("pack", "pack of 25", 25, "piece")],
  "ground pork": [shape("kilogram", "1 kg pack", 1000, "g")],
  "pork belly": [shape("kilogram", "1 kg", 1000, "g")],
  "beef sirloin": [shape("kilogram", "1 kg", 1000, "g")],
  shrimp: [shape("pack", "500 g pack", 500, "g")],
  "sinigang mix": [shape("sachet", "44 g sachet", 44, "g")],
  "mung bean": [shape("pack", "500 g pack", 500, "g")],
  eggplant: [shape("piece", "piece", 1, "piece")],
  "string bean": [shape("bunch", "bunch (250 g)", 250, "g")],
  squash: [shape("kilogram", "1 kg piece", 1000, "g")],
  kangkong: [shape("bunch", "1 bunch (200 g)", 200, "g")],
  malunggay: [shape("bunch", "small bunch", 1, "small bunch")],
  "green papaya": [shape("piece", "piece", 1, "piece")],
  "bean sprout": [shape("pack", "150 g pack", 150, "g")],
  flour: [shape("pack", "1 kg pack", 1000, "g")],
  cabbage: [shape("piece", "1 head", 1, "head")],
  "chicken stock": [shape("liter", "1 L tetra pack", 1000, "ml")],
};
